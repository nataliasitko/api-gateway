export default [
  ...
  { text: 'Tutorials', link: './tutorials/README', collapsed: true, items: [
    ...
    { text: 'Expose a Workload with noAuth - gardener', link: './tutorials/01-35-expose-workload-noauth-gardener.md' },
    { text: 'Expose a Workload with noAuth v2', link: './tutorials/01-35-expose-workload-noauth.md' },
    { text: 'Expose a Workload with noAuth - k3d', link: './tutorials/01-36-expose-workload-noauth-k3d.md' },
